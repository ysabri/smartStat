...
* This is a Spring Boot Gradle project that will only run successfully on Linux, it also assumes specific connection configurations to the Raspberry Pi board for the SG90 servos and DS18B20 temperature sensor
